...
function pintarRectangulo(p1, p2, contexto, relleno) {
    if (relleno === void 0) { relleno = false; }
    contexto.moveTo(p1.x, p1.y);
    contexto.beginPath();
...
function pintarRectangulo2(p1, p2, contexto, relleno) {
    if (relleno === void 0) { relleno = false; }
    contexto.moveTo(p1.x, p1.y);
    contexto.beginPath();
    contexto.lineTo(p1.x, p1.y + p2.y);
...
function pintarRectangulo3(p1, p2, contexto, relleno) {
    if (relleno === void 0) { relleno = false; }
    contexto.moveTo(p1.x, p1.y);
    contexto.beginPath();
    contexto.lineTo(p1.x, p1.y + p2.y);
...
function pintarHexagono(p1, p2, contexto, relleno) {
    if (relleno === void 0) { relleno = false; }
    contexto.moveTo(p1.x, p1.y);
    contexto.beginPath();
...
function pintarOctagono(p1, p2, contexto, relleno) {
    if (relleno === void 0) { relleno = false; }
    contexto.moveTo(p1.x, p1.y);
    contexto.beginPath();
    contexto.lineTo(p1.x - p2.x, p1.y + p2.y);
...
function pintarTriangulo(p1, p2, contexto, relleno) {
    if (relleno === void 0) { relleno = false; }
    contexto.moveTo(p1.x, p1.y);
    contexto.beginPath();
    contexto.lineTo(p1.x, p1.y + p2.y);
...
function pintarPentagono(p1, p2, contexto, relleno) {
    if (relleno === void 0) { relleno = false; }
    contexto.moveTo(p1.x, p1.y);
    contexto.beginPath();
    contexto.lineTo(p1.x - p2.x, p1.y + p2.y);
...
var Tren = /** @class */ (function () {
    ...
    Tren.prototype.hacerTren = function () {
